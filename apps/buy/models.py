...
from apps.sale.models import CarInfo as ci
...
class Cart(models.Model):
    user = models.ForeignKey(ui,verbose_name="用户",on_delete=models.CASCADE)
    car = models.ForeignKey(ci,verbose_name="汽车",on_delete=models.CASCADE)
...
class Order(models.Model):
    buy_user = models.ForeignKey(ui,verbose_name="买家",related_name="buser",on_delete=models.CASCADE)
    sale_user = models.ForeignKey(ui,verbose_name="卖家",related_name="suser",on_delete=models.CASCADE)
